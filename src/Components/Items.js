                        ...
                        newItems.map((item, i) => (
                            <SwiperSlide style={{
                                ...
                                <Box sx={{
                                    ...
                                    <Typography variant='h6' fontWeight={'600'} fontSize={'14px'} color={'#fff'} position={'absolute'} bottom={'45px'}>
                                        <span style={{ color: '#707070', paddingRight: '5px' }}>0.08 ETH</span> 1/20
                                    </Typography>
                                    <a href='#' style={{
                                        color: 'rgb(255, 52, 63)',
                                        textDecoration: 'none',
                                    ...
                                    <Typography onClick={toggleLove} position={'absolute'} right={'15px'} bottom={'20px'} sx={{
                                        transition: 'all .3s ease',
                                        cursor: 'pointer',
                                        color: isClicked ? 'rgb(255, 52, 62)' : '#a2a2a2',
                                    }}>
                                        <span><FavoriteIcon /> {count}</span>
                                    </Typography>
                                </Box>
                            </SwiperSlide>
                        ))
